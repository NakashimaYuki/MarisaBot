...
public class MaiMaiDxDanDataTest
{
    ...
    [TestCase("1.70 十段",          "1.70", "十段")]
    [TestCase("1.70真1段",          "1.70", "真初段")]
    [TestCase("magical 十段",       "1.70", "十段")]
    [TestCase("MAGICAL 真皆传",     "1.70", "真皆伝")]
    [TestCase("MAGiCAL裏皆伝",      "1.70", "裏皆伝")]
    [TestCase("廻十段",              "1.70", "十段")]
    [TestCase("廻 里皆传",           "1.70", "裏皆伝")]
